...
class CHTETest extends PHPUnit_Framework_TestCase
{
  public function setUp()
  {
    ...
    $this->ctrl = new \Chte\Template\ById(
      $this->theme_id,
      $this->csv_id,
      $this->fp
    );
  ...
  {
    $this->objInputCsv = new \Gulei\Csv\Model(array('filepath' => $this->fp));
  ...
  {
    $this->objOutputCsv = new \Gulei\Csv\Model(array('source' => $this->csv_src));
