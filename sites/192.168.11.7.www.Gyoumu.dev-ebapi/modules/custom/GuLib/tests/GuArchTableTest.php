...
XML;
    ...
    $t = new \Gulei\Table\Arch($arch, array());
    $exp = array(
      'f1' => array(
        'data' => 'Field 1',
        'gu_name' => 'f1',
...
XML;
    ...
    $t = new \Gulei\Table\Arch($arch, new G\\Gulei\Provider\Lambda($recs));
...
XML;
  ...
  private function _testCommand($type, $param)
  {
    ...
    $t = new \Gulei\Table\Arch($arch, new G\\Gulei\Provider\Lambda($recs), $param);
    $this->assertEquals($recs, $t->getRecords());
