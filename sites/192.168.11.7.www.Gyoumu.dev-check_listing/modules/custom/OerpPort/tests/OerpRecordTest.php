...
class OerpRecordTest extends PHPUnit_Framework_TestCase
{
  ...
  public function setUp()
  {
    ...
    $this->arch = GuFile::getPathContent('module', 'oerp', '/tests/xml/OerpRecordTest.xml');
  }
  ...
  protected function createStub()
  {
    ...
    return $stub;
    */
    return new OerpRecord($this->arch, '', array('oerp:ids' => '[1713]'));
  }
  ...
  public function testDump()
  {
    ...
    $this->assertXmlStringEqualsXmlString(
      GuFile::getPathContent('module', 'oerp', '/tests/xml/OerpRecordMapped.xml'),
      $stub->dump()
    );
  }
