...
class OerpNestQueryTest extends PHPUnit_Framework_TestCase
{
  ...
  {
    $this->arch = GuFile::getPathContent('module', 'oerp', '/tests/xml/OerpNestQueryTest.xml');
  }

  protected function create()
  {
    return new OerpNestQuery($this->arch);
  }
  ...
  {
    $arch = GuFile::getPathContent('module', 'oerp', '/tests/xml/OerpNestQueryTest2.xml');
    $this->assertNotEmpty($arch);

    $q = new OerpNestQuery($arch);
  ...
  {
    $arch = GuFile::getPathContent('module', 'oerp', '/tests/xml/OerpNestQueryTest3.xml');
    $this->assertNotEmpty($arch);
